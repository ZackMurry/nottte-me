    ...
    return (
        <div>
            ...
            >
                ...
                <form onSubmit={e => handleSubmit(e)} style={{ textAlign: 'center' }}>
                    ...
                    <div>
                        <input
                            ...
                            style={{
                                border: 'none', fontSize: 24, textAlign: 'center', fontColor: 'black', padding: 10
                            }}
                    ...
                    <div>
                        <Button
                            type='submit'
                            style={{
                                backgroundColor: '#2d323e', color: '#fff', padding: '7.5px 15px', margin: 10
                            }}
                        >
                            Sign up
                        </Button>
                ...
                <div style={{
                    display: 'inline-flex', marginTop: '2.5vh', width: '100%', justifySelf: 'center', justifyContent: 'center'
                }}
                >
