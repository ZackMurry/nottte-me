            ...
            >                
                ...
                <div id='table-of-contents' style={{marginTop: '5vh'}}>
                    <Typography variant='h4' style={{textAlign: 'center'}}>
                        <Link href={`/u/${encodeURI(username)}/${encodeURI(title)}/settings#general`}>
                            General
                        </Link>
                    </Typography>
                    <Typography variant='h4' style={{textAlign: 'center'}}>
                        <Link href={`/u/${encodeURI(username)}/${encodeURI(title)}/settings/export`}>
                            Export
                        </Link>
                    </Typography>
                    <Typography variant='h4' style={{textAlign: 'center'}}>
                        <Link href={`/u/${encodeURI(username)}/${encodeURI(title)}/settings/share`}>
                            Share
                        </Link>
                    </Typography>
                </div>
                ...
                <div id='general'>
                    <div id='rename'>
                        ...
                        <div style={{width: '60%', margin: '5vh auto', textAlign: 'center'}}>
                            ...
                            <RenameNoteField name={router.query.title} jwt={jwt} shared={true} />
                        </div>
                    </div>
                    <div id='delete'>
                        <Typography variant='h3' style={{textAlign: 'center'}}>
                        ...
                        <DeleteNoteInSettings jwt={jwt} title={title} shared={true} />
                    </div>
                </div>
