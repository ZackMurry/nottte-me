...
export default function SharedNote() {
    ...
    const getFromServer = async () => {
        ...
        const styleShortcutResponse = await fetch(
        ...
        let newStyleMap = {}
        for (let i = 0; i < parsedStyleShortcuts.length; i++) {
            const styleShortcut = parsedStyleShortcuts[i]
...
nottte.me
            ...
            <div style={{ width: '55%', minWidth: 750, margin: '10vh auto' }} className='note'>
                <div style={{ display: 'inline-flex', width: '100%' }}>
                    ...
                    {/* todo custom settings page for users accessing
                    a shared note (need to change link) */}
