        ...
        >
            ...
            <div>
                <Typography
                    color='primary'
                    style={{
                        fontSize: 128, fontFamily: 'Fjalla One', marginLeft: '7.5vw', marginTop: '10%'
                    }}
                >
                    take notes.
                </Typography>
                <Typography
                    color='primary'
                    style={{
                        fontSize: 48, marginLeft: '7.5vw', marginTop: '-2.5vh', fontWeight: 300
                    }}
                >
                    the place for speedy writing
                </Typography>
                <div style={{
                    width: '20%', margin: '0 auto', marginTop: '25vh', display: 'flex', flexDirection: 'column', alignItems: 'center'
                }}
                >
                    <div>
            ...
            <div ref={contentEl} style={{ position: 'absolute', left: 0, top: '75vh' }} />
            <div style={{ marginTop: '32.5vh', marginBottom: '60vh' }}>
                {/* step one */}
                <div style={{ width: '37.5vw' }}>
                    ...
                    >
                        While our platform has a lot of capabilities,
                        {' '}
                        <br />
                ...
                <div ref={stepTwoEl} style={{ marginTop: '50vh', width: '37.5vw' }}>
                    ...
                    <Typography
                        ...
                        style={{ textAlign: 'right', fontWeight: 300, marginTop: '1vh' }}
                    >
                        Text shortcuts insert text at your current position.
                        {' '}
                        <br />
                        We went ahead and made one for you to try out.
                        {' '}
                        <br />
                ...
                <div ref={stepThreeEl} style={{ marginTop: '50vh', width: '37.5vw' }}>
                    ...
                    <Typography
                        ...
                        style={{ textAlign: 'right', fontWeight: 300, marginTop: '1vh' }}
                    >
                        Style shortcuts apply a style to a region.
                        {' '}
                        <br />
                        If you have something selected, they will apply
                        {' '}
                        <br />
                        styles to the selected region. If not, they activate
                        {' '}
                        <br />
                        the style, so that whatever you type will have that style.
                        {' '}
                        <br />
                        You can press control and Q on your keyboard to use
                        {' '}
                        <br />
                ...
                <div ref={endingEl} style={{ marginTop: '50vh', width: '37.5vw' }}>
                    ...
                    <Typography variant='h5' color='primary' style={{ fontWeight: 300, paddingTop: '1vh', textAlign: 'right' }}>
                        Everything is free
                    </Typography>
                    <LandingPageSignUp />
                </div>
